    ...
    private function demoUsers(): array
    {
        return [
            [
                'name' => 'Demo Manager',
                'username' => 'manager',
                'email' => 'manager@frontiershop.rw',
                'role' => 'MANAGER',
            ],
            [
                'name' => 'Demo Cashier',
                'username' => 'cashier',
                'email' => 'cashier@frontiershop.rw',
                'role' => 'CASHIER',
            ],
            [
                'name' => 'Demo Waiter',
                'username' => 'waiter',
                'email' => 'waiter@frontiershop.rw',
                'role' => 'WAITER',
            ],
            [
                'name' => 'Demo Store Keeper',
                'username' => 'storekeeper',
                'email' => 'storekeeper@frontiershop.rw',
                'role' => 'STORE_KEEPER',
            ],
            [
                'name' => 'Demo Kitchen Chief',
                'username' => 'kitchen',
                'email' => 'kitchen@frontiershop.rw',
                'role' => 'KITCHEN_CHIEF',
                'department' => 'KITCHEN',
            ],
            [
