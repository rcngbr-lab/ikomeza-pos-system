    ...
    */
    ...
    private function normalizeOperationalRole(string $role): string
    {
        ...
        return match (true) {
            ...
            str_contains($role, 'KITCHEN') && str_contains($role, 'CHIEF') => 'KITCHEN_CHIEF',
            str_contains($role, 'BAR') && str_contains($role, 'MANAGER') => 'BAR_MANAGER',
            str_contains($role, 'BAR') && str_contains($role, 'CHIEF') => 'BAR_CHIEF',
            ...
            str_contains($role, 'WAITER') => 'WAITER',
            str_contains($role, 'SERVER') => 'SERVER',
            str_contains($role, 'CASHIER') => 'CASHIER',
            str_contains($role, 'BARTENDER') => 'BARTENDER',
            default => $role ?: 'STAFF',
        };
    }
